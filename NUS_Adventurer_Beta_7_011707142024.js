...
const building_2 = update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/USC_Updated.png"), [0.25, 0.25]);
const University_Sports_Center = update_position(building_2, [310, 225]);
...
const coin1 = update_position(still_obj_01, [math_random() * 1550, math_random() * 1000]);
...
const coin2 = update_position(still_obj_02, [math_random() * 1550, math_random() * 1000]);

const still_obj_03 = update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Coins_test.png"), [0.05, 0.05]);
const coin3 = update_position(still_obj_03, [math_random() * 1550, math_random() * 1000]);

const still_obj_04 = update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Coins_test.png"), [0.05, 0.05]);
const coin4 = update_position(still_obj_04, [math_random() * 1550, math_random() * 1000]);

const still_obj_05 = update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Coins_test.png"), [0.05, 0.05]);
const coin5 = update_position(still_obj_05, [math_random() * 1550, math_random() * 1000]);

const still_obj_06 = update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Coins_test.png"), [0.05, 0.05]);
const coin6 = update_position(still_obj_06, [math_random() * 1550, math_random() * 1000]);
// ---------------------------------------------
...
// const playerB = update_position(the_space_invader, [0, 600]); // 0, 600
...
// ----------pop/un-pop information--------------------    
    if(gameobjects_overlap(explorer, test_case)) {
...
// ----------A Collecting Coins--------------------------
    ...
    if(gameobjects_overlap(playerA, coin3)){
        num_of_coins_A = num_of_coins_A + 1;
        coin_sound();
        update_text(score_A, "Player A: " + stringify(num_of_coins_A));
        update_position(coin3, [faraway, faraway]);
    }
    
    if(gameobjects_overlap(playerA, coin4)){
        num_of_coins_A = num_of_coins_A + 1;
        coin_sound();
        update_text(score_A, "Player A: " + stringify(num_of_coins_A));
        update_position(coin4, [faraway, faraway]);
    }
    
    if(gameobjects_overlap(playerA, coin5)){
        num_of_coins_A = num_of_coins_A + 1;
        coin_sound();
        update_text(score_A, "Player A: " + stringify(num_of_coins_A));
        update_position(coin5, [faraway, faraway]);
    }
    
    if(gameobjects_overlap(playerA, coin6)){
        num_of_coins_A = num_of_coins_A + 1;
        coin_sound();
        update_text(score_A, "Player A: " + stringify(num_of_coins_A));
        update_position(coin6, [faraway, faraway]);
    }
// ----------------------------------------------------
// ----------B Collecting Coins--------------------------
    if(gameobjects_overlap(playerB, coin1)){
    ...
    if(gameobjects_overlap(playerB, coin2)){
        num_of_coins_B = num_of_coins_B + 1;
        coin_sound();
        update_text(score_B, "Player B: " + stringify(num_of_coins_B));
        update_position(coin2, [faraway, faraway]);
    ...
    if(gameobjects_overlap(playerB, coin3)){
        num_of_coins_B = num_of_coins_B + 1;
        coin_sound();
        update_text(score_B, "Player B: " + stringify(num_of_coins_B));
        update_position(coin3, [faraway, faraway]);
    ...
    if(gameobjects_overlap(playerB, coin4)){
        num_of_coins_B = num_of_coins_B + 1;
        coin_sound();
        update_text(score_B, "Player B: " + stringify(num_of_coins_B));
        update_position(coin4, [faraway, faraway]);
    ...
    if(gameobjects_overlap(playerB, coin5)){
        num_of_coins_B = num_of_coins_B + 1;
        coin_sound();
        update_text(score_B, "Player B: " + stringify(num_of_coins_B));
        update_position(coin5, [faraway, faraway]);
    ...
    if(gameobjects_overlap(playerB, coin6)){
        num_of_coins_B = num_of_coins_B + 1;
        coin_sound();
        update_text(score_B, "Player B: " + stringify(num_of_coins_B));
        update_position(coin6, [faraway, faraway]);
